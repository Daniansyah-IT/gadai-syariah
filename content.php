    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                          <a class="nav-link" href="register.php">
                            ...
                            <span class="ml-2">Register Users</span>
                          </a>
                        </li>
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <h1 class="h2">Kelola Konten</h1>
                <!-- form update slider -->
                <div class="container mt-5" width="500">
                    <h2>Upload Gambar Slider</h2>
                    <p class="">Sebelum mengedit gamabar ganti nama gambar "slide1" pastikan file ekstensi PNG</p>
                    <?php
                    ...
                    foreach ($images as $image) {
                        if ($image !== "." && $image !== "..") {
                            echo "<div>";
                            echo "<img src='img/carousel/$image' width='500' alt='$image'>";
                            echo "<a href='edit.php?image=$image'>Edit</a>";
                            echo "<a href='delete.php?image=$image'>Delete</a>";
                            echo "</div>";
                        }
                    }
                    ?>
